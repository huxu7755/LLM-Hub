...
public static let models: [AIModel] = [
    ...
    AIModel(
        id: "sd-v1-5-apple-palettized-original",
        name: "Stable Diffusion v1.5 (GPU)",
        description: "Stable Diffusion v1.5 — Apple official palettized original bundle for CPU/GPU deployment. Generates 512×512 images. Requires iOS 17+. (1.56 GB)",
        url: "https://huggingface.co/apple/coreml-stable-diffusion-v1-5-palettized/resolve/main/coreml-stable-diffusion-v1-5-palettized_original_compiled.zip?download=true",
        category: .imageGeneration,
